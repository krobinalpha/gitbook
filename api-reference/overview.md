...
This section documents the **public** BondX REST API. Only endpoints that do not require authentication and are not admin-only are listed. Use these endpoints to read token data, rankings, chat messages, and to initiate authentication flows.
...
| [Users](/broken/pages/JH7W96ZngjSsRGtrStKT) | Public user profile by wallet address                                                                |
| [Auth](/broken/pages/ViGJfqr5SQc3SqPVtTP2)  | Nonce, verify wallet (SIWE), send/verify email code, initiate social login                           |
| [Analytics](analytics.md)                   | Dashboard rankings (traders, points), platform stats                                                 |
| [Chat](/broken/pages/Mov0ss1UXJcRHZB1FrcP)  | List chat messages for a token                                                                       |
