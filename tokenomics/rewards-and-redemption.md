...
If BondX markets “1 point = 1 BONDX”, the deployed contract implementation must match this. This whitepaper assumes the on-chain redemption mechanism mints BONDX at the correct 18-decimal scale.
